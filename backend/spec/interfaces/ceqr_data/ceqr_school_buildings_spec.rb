...
RSpec.describe "CeqrData Ceqr School Buildings", type: :model do
  ...
  context "ceqr_school_buildings" do
    ...
    ### PRIMARY SCHOOL ceqr_school_buildings VERSION 2019
    it "returns an array of ceqr_school_buildings that match subdistrict VERSION 2019" do
      subdistricts = ["(2,1)"]

      ps_schools = ceqr_school_buildings_2019.ps_schools_in_subdistricts(subdistricts)
    ...
    it "returns an array of ceqr_school_buildings that match subdistrict VERSION 2018" do
      ...
      ps_schools = ceqr_school_buildings_2018.ps_schools_in_subdistricts(subdistricts)
    ...
    it "returns an array of ceqr_school_buildings that match subdistrict VERSION 2017" do
      ...
      ps_schools = ceqr_school_buildings_2017.ps_schools_in_subdistricts(subdistricts)
    ...
    ### INTERMEDIATE SCHOOL ceqr_school_buildings VERSION 2019
    it "returns an array of intermediate ceqr_school_buildings that match subdistrict for VERSION 2019" do
      subdistricts = ["(2,1)"]

      is_schools = ceqr_school_buildings_2019.is_schools_in_subdistricts(subdistricts)
    ...
    it "returns an array of intermediate ceqr_school_buildings that match subdistrict for VERSION 2018" do
      ...
      is_schools = ceqr_school_buildings_2018.is_schools_in_subdistricts(subdistricts)
    ...
    it "returns an array of intermediate ceqr_school_buildings that match subdistrict for VERSION 2017" do
      ...
      is_schools = ceqr_school_buildings_2017.is_schools_in_subdistricts(subdistricts)
    ...
    ### HIGH SCHOOL ceqr_school_buildings VERSION 2019
    it "returns an array of high school ceqr_school_buildings that match borough for VERSION 2019" do
      boroIntegers = [1, 2]

      hs_schools = ceqr_school_buildings_2019.high_schools_in_boro(boroIntegers)
