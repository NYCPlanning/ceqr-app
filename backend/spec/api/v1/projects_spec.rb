...
RSpec.describe 'projects', type: :request do
  describe 'POST /api/v1/project' do
    ...
    describe 'basic create' do
      ...
      it "sets subdistricts from db correctly" do
      ...
      it "sets futureEnrollmentMultipliers correctly" do
      ...
      it "sets futureEnrollmentProjections correctly" do
      ...
      it "sets hsProjections correctly" do
        # "hs-projections":
        # [
        #     {
        #         "hs": 79555,
      ...
      it "sets futureEnrollmentNewHousing" do
      ...
      it "sets hsStudentsFromHousing" do
        # "hs-students-from-housing": 4643,
      end
      
      it "sets scaProjects" do
        # "sca-projects":
        # [
        #     {
    ...
    describe "update" do
      xit "updates relevant attributes when project is changed"
    end
  end
end
