...
export default Component.extend({
  ps: computed('project.{aggregateTotals,schoolsWithAction}.@each', function() {
  ...
  is: computed('project.{aggregateTotals,schoolsWithAction}.@each', function() {
    return SchoolLevelTotals.create({
  ...
  hs: computed('project.{aggregateTotals,schoolsWithAction}.@each', function() {
    return SchoolLevelTotals.create({
