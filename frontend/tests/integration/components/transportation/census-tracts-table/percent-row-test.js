...
module('Integration | Component | transportation/census-tracts-table/percent-row', function(hooks) {
  ...
  test('it creates a row with title and numeric percent', async function(assert) {
    ...
    await render(hbs`{{transportation/census-tracts-table/percent-row title=title allModalSplitData=modalSplits variables=variables}}`);
