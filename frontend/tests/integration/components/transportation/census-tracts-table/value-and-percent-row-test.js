...
module('Integration | Component | transportation/census-tracts-table/value-and-percent-row', function(hooks) {
  ...
  test('it creates a row with title and pair of numeric count and percent', async function(assert) {
    ...
    const modalSplits = this.owner.lookup('service:readonly-ceqr-data-store').findByIds('ACS-modal-split', ['1']);
