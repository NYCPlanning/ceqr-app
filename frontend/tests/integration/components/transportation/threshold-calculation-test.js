...
module(
  'Integration | Component | transportation/threshold-calculation',
  function (hooks) {
    ...
    test('it renders', async function (assert) {
      ...
      await render(
        hbs`{{transportation/threshold-calculation analysis=transportationModel}}`
      );
      ...
      assert.ok(
        this.element
          .querySelector('[data-test-popup="detailed analysis"]')
          .textContent.includes('7.01')
      );
      ...
      assert.ok(
        this.element
          .querySelector('[data-test-office-threshold]')
          .textContent.includes('100000')
      );
      ...
      assert.ok(
        this.element
          .querySelector('[data-test-residential-threshold]')
      ...
      assert.ok(
        this.element
          .querySelector('[data-test-regional-retail-threshold]')
          .textContent.includes('20000')
      );
      ...
      assert.ok(
        this.element
          .querySelector('[data-test-local-retail-threshold]')
          .textContent.includes('15000')
      );
      ...
      assert.ok(
        this.element
          .querySelector('[data-test-restaurant-threshold]')
          .textContent.includes('20000')
      );
      ...
      assert.ok(
        this.element
          .querySelector('[data-test-community-facility-threshold]')
          .textContent.includes('25000')
      );
      ...
      assert.ok(
        this.element
          .querySelector('[data-test-off-street-parking-threshold]')
          .textContent.includes('85')
      );
    });
  }
);
