...
export default Component.extend({
  ...
  NA_newResidentialDevelopment: computed(
    'activeSchoolsLevel',
    'analysis.futureResidentialDev',
    function () {
  ...
  NA_significantUtilChanges: computed(
    'activeSchoolsLevel',
    'analysis.buildings.[]',
    function () {
  ...
  WA_newSchools: computed(
    'activeSchoolsLevel',
    'analysis.schoolsWithAction.[]',
    function () {
