...
/**
 * PercentRowComponent renders a TableRow in the Census Tracts table, populated with the modal
 * split percent for the given variables.
 * (see helpers/get-split-percent and helpers/get-aggregate-percent)
 */
export default class TransportationCensusTractsTablePercentRowComponent extends Component {
  tagName = 'tr';
  /**
