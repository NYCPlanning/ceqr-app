...
/////////// CAPACITY ///////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  capacityNoActionTotal: computed('hsCapacityFuture', 'scaCapacityIncrease', function() {
    return this.hsCapacityFuture + this.scaCapacityIncrease;
  }),
  ...
  mitigateUnitCount: computed('mitigateSeatCount', function() {
    return Math.ceil(this.get('mitigateSeatCount') / this.studentMultiplier);
  }),
});